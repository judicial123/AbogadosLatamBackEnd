...
namespace AbogadosLatam.DataSore.MSSQL.Migrations
{
    ...
    [Migration("20250212200504_AddEstudioEspecialidadRelation")]
    partial class AddEstudioEspecialidadRelation
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("AbogadosLatam.Domain.Pais", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            DateCreated = new DateTime(2025, 2, 12, 15, 5, 3, 515, DateTimeKind.Local).AddTicks(2180),
                            DateModified = new DateTime(2025, 2, 12, 15, 5, 3, 515, DateTimeKind.Local).AddTicks(2220),
                            Nombre = "Ecuador"
                        });
                });
