...
namespace AbogadosLatam.DataSore.MSSQL.Migrations
{
    ...
    [Migration("20250212113556_EstudiosTable")]
    partial class EstudiosTable
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("AbogadosLatam.Domain.Pais", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            DateCreated = new DateTime(2025, 2, 12, 6, 35, 56, 90, DateTimeKind.Local).AddTicks(7390),
                            DateModified = new DateTime(2025, 2, 12, 6, 35, 56, 90, DateTimeKind.Local).AddTicks(7420),
                            Nombre = "Ecuador"
                        });
                });
